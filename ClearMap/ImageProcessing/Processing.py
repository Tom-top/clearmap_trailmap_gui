...
In this way a nested heirachy of steps can be build, only a single chain
is supported, combination of multiple steps into one result has to be done within
a single step
"""
