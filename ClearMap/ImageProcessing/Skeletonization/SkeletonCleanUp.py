...
#import ClearMap.ImageProcessing.Skeletonization.SkeletonCleanUpCode as code
...
def transferRadii(points_from, radii_from, points_to, radii_to):
...
if __name__ == '__main__':
  ...
  #data_f[points] = 160; 
  dv.dualPlot(np.asarray(skel, dtype = int) + 2 * skel_3 + 4 * skel_1, 
