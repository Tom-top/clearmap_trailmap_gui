...
import ClearMap.ImageProcessing.pickle4reducer as pickle4reducer;
...
#    print(sys.getsizeof(img)/1000000000.)
...
def writeSubStack(filename, img, subStack = None):
    ...
    return io.writeData(filename, img[:,:,ii:ee] , startIndex = si ); #, startIndex = si  
