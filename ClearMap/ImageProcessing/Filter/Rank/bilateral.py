...
def _apply(func, image, selem, out, mask, shift_x, shift_y, shift_z, s0, s1,
           out_dtype=None):
...
def mean_bilateral(image, selem, out=None, mask=None, shift_x=False,
                   shift_y=False, shift_z=False, s0=10, s1=10):
    ...
    return _apply(bilateral_cy._mean, image, selem, out=out,
                  mask=mask, shift_x=shift_x, shift_y=shift_y, shift_z=shift_z, s0=s0, s1=s1)
