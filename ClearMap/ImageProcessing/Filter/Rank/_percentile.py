...
def _apply(func, image, selem, out, mask, shift_x, shift_y, shift_z, p0, p1,
           out_dtype=None):
...
def autolevel_percentile(image, selem, out=None, mask=None, shift_x=False,
                         shift_y=False, shift_z=False, p0=0, p1=1):
    ...
    return _apply(percentile_cy._autolevel,
                  ...
                  shift_y=shift_y, shift_z=shift_z, p0=p0, p1=p1)
...
def subtract_mean_percentile(image, selem, out=None, mask=None,
                             shift_x=False, shift_y=False, shift_z=False, p0=0, p1=1):
...
def percentile(image, selem, out=None, mask=None, shift_x=False, shift_y=False, shift_z=False,
               p0=0):
    ...
    return _apply(percentile_cy._percentile,
                  image, selem, out=out, mask=mask, shift_x=shift_x,
                  shift_y=shift_y, shift_z=shift_z, p0=p0, p1=0.)
...
def threshold_percentile(image, selem, out=None, mask=None, shift_x=False,
                         shift_y=False, shift_z=False, p0=0):
