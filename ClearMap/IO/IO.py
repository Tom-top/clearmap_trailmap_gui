...
#arrayFileExtensions = ["csv", "txt", "vtk", "ims", "npy"];
#"""list of supported array file extensions"""
#
#arrayFileTypes = ["CSV", "VTK", "Imaris", "NPY", "MMP"];
#"""list of array file types"""
#
#arrayFileExtensionToType = {"csv" : "CSV", "txt" : "CSV", "vtk" : "VTK", "ims" : "Imaris",  "npy" : "MMP"};
#"""map from array file extensions to array file types"""
#
#
#imageFileExtensions = ["tif", "tiff", "mhd", "raw", "ims", "nrrd", "npy"];
#"""list of supported image file extensions"""
#
#imageFileTypes = ["FileList", "TIF", "RAW", "NRRD", "Imaris", "NPY", "MMP"]
#"""list of image data file types"""
#
#imageFileExtensionToType = { "tif" : "TIF", "tiff" : "TIF", "raw" : "RAW", "mhd" : "RAW", "nrrd": "NRRD", "ims" : "Imaris", "npy" : "MMP"}
#"""map from image file extensions to image file types"""
#
#
#dataFileExtensions = arrayFileExtensions + imageFileExtensions
#"""list of supported data files"""
#
#dataFileTypes = arrayFileTypes + imageFileTypes
#"""list of data file types"""
#
#dataFileExtensionToType = joinParameter(arrayFileExtensionToType, imageFileExtensionToType);
...
dataFileExtensions = ["tif", "tiff", "mhd", "raw", "ims", "nrrd", "npy", "skl"];
"""list of extensions supported as a image data file"""

dataFileTypes = ["FileList", "TIF", "RAW", "NRRD", "Imaris", "MMP", "SKL"]
"""list of image data file types"""

dataFileExtensionToType = { "npy" : "MMP", "tif" : "TIF", "tiff" : "TIF", "raw" : "RAW", "mhd" : "RAW", "nrrd": "NRRD", "ims" : "Imaris", "skl" : "SKL"}
"""map from image file extensions to image file types"""
...
from .FileUtils import  fileExtension, isFile, isFileExpression, isFileName, createDirectory, copyFile
...
def dataType(source, z = all, **args):
    """Returns dtype
    ...
    if isinstance(source, str):
        mod = dataFileNameToModule(source);
        return mod.dataType(source, **args);
    elif isinstance(source, numpy.ndarray):
        return source.dtype
    else:
        raise RuntimeError("dataType: argument not a string or array!");  
...
def cropData(source, sink = None, x = all, y = all, z = all, **args):
  ...
  if isinstance(source, numpy.ndarray):
    ...
    mod = dataFileNameToModule(source);
    if sink is None or (isinstance(sink, str) and dataFileNameToModule(sink) == mod):
    ...
    if source is None:
        ...
        if sink is None:        
            ...
            if args == {} and dataFileNameToType(source) == dataFileNameToType(sink):
              ...
              if isFileExpression(source) and isFileName(sink):
                mod = importlib.import_module("ClearMap.IO.FileList");
                return mod.convertToNPY(source, sink, **args);
              else:
