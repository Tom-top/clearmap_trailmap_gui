...
#    e1 = [x for x in imgxml.iter('{*}xyz-Table X Overlap')];
#    e2 = [x for x in imgxml.iter('{*}xyz-Table Y Overlap')];
#    print(e1, e2)
...
def xmlImportFile(regularExpression, size = None, overlap = None, addOverlap = 0, origin = None, resolution = None, tiling = None, tileExpression = None, zRange = None, xmlImportFile = None, asString = False,ff=None):
