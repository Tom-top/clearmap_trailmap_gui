...
homedir = '/raid/thomas.topilko/Grace_Trailmap_Analysis' #Directory where the data folders will be placed '/mnt/raid/Thomas_TOPILKO/'
experiment = 'trailmap' #Prefix of the name of the folders to analyze. Format : "name-XXX"
